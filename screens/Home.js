...
const HomeScreen = () => {
  ...
  const renderItem = ({item}) =>{
    return(
      <Pressable style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 10, marginVertical: 8, backgroundColor: '#282828', borderRadius: 4, elevation: 3}}>
      ...
      start={{x: 1, y: 0}} end={{x: 0, y: 1}}>
        <ScrollView style={{marginTop: 50}}>
          ...
          <View style={{flexDirection: 'row', gap: 20, margin: 10}}>
            <Pressable style={{backgroundColor: '#363836', padding: 10, borderRadius: 20}}>
            ...
            <Pressable style={{
              ...
              <LinearGradient colors={['#33006F', '#FFFFFF']}>
                <Pressable style={{width: 55, height: 55, justifyContent: 'center', alignItems: 'center'}}>
                  <Image style={{height: 24, width: 24}} source={require ('../assets/icons/like-light.png')}/>
                </Pressable>
              </LinearGradient>
